...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set echo [ create_bd_port -dir I -from 0 -to 0 echo ]
  set trigger [ create_bd_port -dir O -from 0 -to 0 trigger ]

  # Create instance: echo, and set properties
  set echo [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 echo ]
  ...
  set trigger [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 trigger ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {2} \
  ...
  connect_bd_net -net In0_0_1 [get_bd_ports echo] [get_bd_pins echo/In0]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins trigger/Din]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins echo/dout] [get_bd_pins processing_system7_0/GPIO_I]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports trigger] [get_bd_pins trigger/Dout]
